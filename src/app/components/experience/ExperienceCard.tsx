...
export const ExperienceCard:React.FC<ExperienceCardProps> = ({exp}) => {
  return (
    <div className={`bg-box-bg my-5 p-4 rounded-xl lg:flex lg:items-center shadow-xl transition-all hover:transform-[scale(1.015)] ${exp.id%2==0?'lg:flex-row-reverse':''}`}> 
