...
export const ExperienceCard:React.FC<ExperienceCardProps> = ({exp}) => {
  return (
    <div className={`bg-box-bg my-5 p-4 rounded-xl lg:flex lg:items-center ${exp.id%2==0?'lg:flex-row-reverse':''}`}> {/* conditional justify-between */}
      ...
      />
      <div className='lg:ml-4 lg:flex-2'>
        <h3>{exp.title}</h3>
        <p>{exp.company}</p>
        <p>{exp.dateRange}</p>
